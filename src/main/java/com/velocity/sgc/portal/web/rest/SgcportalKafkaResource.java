...
@RestController
@RequestMapping("/api/sgcportal-kafka")
public class SgcportalKafkaResource {
    private final Logger log = LoggerFactory.getLogger(SgcportalKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SgcportalKafkaResource(KafkaProperties kafkaProperties) {
